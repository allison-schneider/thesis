...
% Say something about analysis data vs. forecast data and data resolution. It may be pretty hard to ascribe the differences to any particular part of the approaches.
